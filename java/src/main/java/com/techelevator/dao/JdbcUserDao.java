...
//    }
    ...
    public User createUser(RegisterUserDto user) {
        ...
        try {
            ...
            String insertRolesIdsSql = "INSERT INTO roles (user_id) VALUES (?)";
            jdbcTemplate.update(insertRolesIdsSql, newUserId);

//            String insertChefSql = "INSERT INTO chefs (chef_id) VALUES (?)";
//            jdbcTemplate.update(insertChefSql, newUserId);
//
//            String insertAttendeeSql = " INSERT INTO attendees (attendee_id) VALUES (?)";
//            jdbcTemplate.update(insertAttendeeSql, newUserId);
